                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="header-head">
                            <img className="header-logo" src="/assets/images/header-img/logo 512.png" />
                    ...
                    <div className="col-md-6">
                        <div className="header-txt">
                            <div className="header-num mobile-hide">
                            ...
                            <a className="header-enquire-button mobile-hide" onClick={openPopup}>
